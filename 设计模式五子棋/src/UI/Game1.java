...
public class Game1 extends JFrame implements Obs
{

    public Game1() throws HeadlessException, IOException, InterruptedException
    {
        this.initWindow();
...
//        InfoPanel infoPanel = new InfoPanel();
        ...
        SinglePlayerGame chessboardPanel =new SinglePlayerGame("human");
